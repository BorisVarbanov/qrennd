...
# %%
decoders = ("mwpm", "neural_network")

colors = dict(neural_network="#f44336", mwpm="#03a9f4")

labels = dict(neural_network="Neural Network", mwpm="MWPM")

markers = dict(mwpm="o", neural_network="h")
...
prob_ax.axvline(40, ymin=0, ymax=1, color="grey", linestyle="--")
prob_ax.text(45, 0.25, "training", rotation=-90, ha="center", va="center")

fid_ax.axvline(40, ymin=0, ymax=1, color="grey", linestyle="--")
fid_ax.text(45, 0.3, "training", rotation=-90, ha="center", va="center")
...
for decoder in decoders:
    ...
    label = f"{decoder_label} $\\varepsilon_L$ = ({error_rate:.3f} $\pm$ {rate_stderr:.3f})%"
